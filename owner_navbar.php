...
else 
{
  ...
  onmouseout="this.style.color=\'#8ac85e\'; this.style.background=\'whitesmoke\'; this.style.transition=\'all .5s\'">Welcome '.$_SESSION["owner_boxname"].'</a></li>
...
.navbar-brand {
  ...
  -->
    ...
    z-index: 100;">
      <div class="container-fluid" style="width:100%">
        <div style="width:40%"> 
          ...
          <a class="navbar-brand" href="" style="font-size:35px;color: #8ac85e;">PlayBox</a>
    ...
    width: 100%;">
            <li class="nav-item">
              <a class="nav-link active " aria-current="page" href="owner_home.php" style="font-size:20px; color: #8ac85e;"
            ...
            <li class="nav-item">
              <a class="nav-link " href="owner_aboutus.php"  style="font-size:20px; color: #8ac85e;"
              onmouseover="this.style.color='white'; this.style.borderRadius='5px'; this.style.background='#8ac85e';this.style.transition='all .5s'" onmouseout="this.style.color='#8ac85e';this.style.background='whitesmoke';this.style.transition='all .5s'";
              >About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="addnewbox.php"  style="font-size:20px; color: #8ac85e;"
              onmouseover="this.style.color='white';  this.style.borderRadius='5px'; this.style.background='#8ac85e';this.style.transition='all .5s'" onmouseout="this.style.color='#8ac85e';this.style.background='whitesmoke';this.style.transition='all .5s'"
              
              >Add New Box</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="editbox.php"  style="font-size:20px; color: #8ac85e;"
              onmouseover="this.style.color='white';  this.style.borderRadius='5px'; this.style.background='#8ac85e';this.style.transition='all .5s'" onmouseout="this.style.color='#8ac85e';this.style.background='whitesmoke';this.style.transition='all .5s'"
              >Edit Box</a>
            </li>
            <ul class="navbar-nav">

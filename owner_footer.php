...
<footer class="flex-rw" style="margin-top:25px;">
  ...
  <ul class="footer-list-top">
    <li>
      ...
      <li><a href='login.php' class="generic-anchor footer-list-anchor">LOGIN</a></li>
  </ul>
  <ul class="footer-list-top">
    <li id='help'>
      <h4 class="footer-list-header">Admin</h4></li>
      <li><a href='adminlogin.php' class="generic-anchor footer-list-anchor" itemprop="significantLink">LOGIN</a></li>
  </ul>
  ...
  <section class="footer-bottom-section flex-rw">
    <div class="footer-bottom-wrapper">   
      ...
      </i> 2023 , <address class="footer-address" role="company address">PlayBox - Slot Booking System</address><span class="footer-bottom-rights"> - All Rights Reserved - </span>
    </div>
    <div class="footer-bottom-wrapper">

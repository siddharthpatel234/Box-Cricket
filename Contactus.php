...
if(isset($_POST["btnsubmitcontact"]))
{
    ...
    $email=$_POST["email"];
    $phone=$_POST["phone"];
    $messg=$_POST["txtareamsg"];
    
    $con=new connec();
    $sql="INSERT INTO `contact` VALUES (0,'$fname','$lname','$email','$phone','$messg',now())";
    $con->insert($sql,"We will Contact You Soon");
          ...
          <div class="get_form_inner">
            ...
            <form action="Contactus.php" method="POST">
              <div class="grid-50-50">
                ...
                <input type="tel" placeholder="Phone/Skype" name="phone">
              </div>
              <div class="grid-full">
                <textarea placeholder="Message" cols="30" rows="10" name="txtareamsg"></textarea>
                <input type="submit" value="Submit" name="btnsubmitcontact">
              </div>
            </form>
          </div>
        </div>
        <div class="colmun-30 get_say_form" style="background-color: #8ac85e;">
          <h5>Say Hi!</h5>
          <ul class="get_say_info_sec">
            <li>
              <i class="fa fa-envelope"></i>
              <a href="mailto:">playbox123@gmail.com</a>
            </li>
            <li>
